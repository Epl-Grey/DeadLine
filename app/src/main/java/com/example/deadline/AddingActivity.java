...
public class AddingActivity extends AppCompatActivity {
    ...
    void setNotificationAlarm(){
        ...
        dateCursor = db.rawQuery("SELECT " + DatabaseHelper.COLUMN_DATE + ", " + DatabaseHelper.COLUMN_TIME +  " FROM " + DatabaseHelper.TABLE +" ORDER BY " + DatabaseHelper.COLUMN_DATE + " ASC", null);
